...
class Item(models.Model):
    ...
    static_item = models.ForeignKey(Item_Definition, on_delete=models.DO_NOTHING, null=True)
    owner = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.SET_NULL, null=True)
    item_location = models.ForeignKey(Item_Location, on_delete=models.CASCADE, null=True)
